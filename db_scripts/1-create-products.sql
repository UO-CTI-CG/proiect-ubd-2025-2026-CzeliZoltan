...
-- Schema cartify_db
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `cartify_db`;

CREATE SCHEMA `cartify_db`;
USE `cartify_db` ;

-- -----------------------------------------------------
-- Table `cartify_db`.`product_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cartify_db`.`product_category` (
...
-- -----------------------------------------------------
-- Table `cartify_db`.`product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cartify_db`.`product` (
    `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
